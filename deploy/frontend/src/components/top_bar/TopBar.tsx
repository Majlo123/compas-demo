    ...
    <div className="flex flex-col gap-4">
      {managingLevel ? (
        <div className="flex gap-3 items-center">
          <h1 className="text-h3 text-secondary m-0 font-bold">
            Managing: {managingLevel?.name}
          </h1>
          <p className="text-p2 text-disabled m-0">
            {managingLevel?.description}
          </p>
        </div>
      ) : (
        <div>
          <p className="text-p2 text-disabled m-0">
            Select a warning level to manage
          </p>
        </div>
      )}
      <div className="flex gap-10 items-center">
        ...
        <div className="flex gap-5">
          ...
          <Button
            ...
            className="w-36 justify-start pl-7"
          >
