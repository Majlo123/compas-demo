...
const TableIconEdit: FC<SVGComponentProps> = ({ className = '' }) => {
  return (
    <svg
      className={className}
      width="16"
...
export default React.memo(TableIconEdit);
