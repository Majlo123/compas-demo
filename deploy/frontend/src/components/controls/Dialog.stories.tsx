        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[500px]">
                ...
                <DialogFooter className="px-6 pb-6 pt-0 sm:justify-center flex-col sm:flex-col gap-3">
                    <Button variant="primary" className="w-full bg-gray-400 hover:bg-gray-500 text-white border-none">Create Par Level</Button>
                    <DialogClose asChild>
                        <Button variant="secondary" className="w-full rounded-full">Cancel</Button>
                    </DialogClose>
                </DialogFooter>
            </DialogContent>
        </Dialog>
